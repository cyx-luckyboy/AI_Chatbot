<template>
  <div class="message-input w-full shadow-sm border rounded-lg border-gray-300 py-1 px-2 focus-within:border-green-700">
    ...
    <div class="flex items-end gap-1">
      ...
      />
      <textarea
        class="outline-none border-0 flex-1 min-w-0 min-h-[40px] max-h-[200px] py-2 px-1 bg-white focus:ring-0 resize-y leading-snug"
        v-model="model"
        :disabled="disabled"
        rows="1"
...
/** Enter 发送；Shift+Enter 换行（默认插入换行，不拦截） */
