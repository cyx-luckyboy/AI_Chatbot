<template>
  <div class="conversation-list">
    <div
      ...
      :class="{
        'bg-gray-100 dark:bg-slate-800': store.selectedId === item.id,
        'bg-white dark:bg-slate-900/80': store.selectedId !== item.id,
      }"
    ...
    >
      <div
        ...
        :class="store.selectedId === item.id ? 'hover:bg-gray-200 dark:hover:bg-slate-700' : ''"
